...
# ../Precompute/build/featpush -algo featreuse -data_folder ../data/pubmed -estimation_folder ../save/pubmed/featreuse/0 -graph adj.txt -feats feats_normt.npy -thread_num 1 -seed 0 -alpha 0.1 -epsilon 2
